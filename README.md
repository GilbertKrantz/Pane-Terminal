...
- The active-command mirror is presentation-only. It does not own the PTY, resize it, send terminal replies, or accept keyboard and mouse input.
- Finalized blocks are plain-text snapshots. They do not preserve colors or terminal interactivity; Terminal mode is the authoritative view.
